...
export const STATIC_PATTERNS: PatternRule[] = [
  ...
  {
    patterns: ['add return type', 'create constant', 'extract constant',
      'add export', 'remove unused', 'dead code'],
    route: 'local', level: 1, confidence: 0.90, cost_of_wrong: 'trivial',
    category: 'codegen',
  },
  ...
  {
    patterns: ['explain this error', 'what does this regex',
      'what is this pattern', 'how does this work'],
    route: 'local', level: 2, confidence: 0.85, cost_of_wrong: 'trivial',
    category: 'analysis',
  },
  {
    patterns: ['write getter', 'write setter', 'add accessor',
      'generate constructor', 'create factory'],
    route: 'local', level: 2, confidence: 0.85, cost_of_wrong: 'low',
    category: 'codegen',
  },
  ...
  {
    patterns: ['write migration', 'add middleware', 'create hook',
      'add decorator', 'write plugin'],
    route: 'local', level: 3, confidence: 0.75, cost_of_wrong: 'medium',
    category: 'codegen',
  },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    patterns: ['debug this', 'why is this failing', 'fix this error',
      'why does this return', 'what is wrong with'],
    route: 'local', level: 4, confidence: 0.65, cost_of_wrong: 'medium',
    category: 'analysis',
  },
  {
    patterns: ['optimize this function', 'make this faster',
      'reduce memory usage', 'improve performance of'],
    route: 'local', level: 4, confidence: 0.65, cost_of_wrong: 'medium',
    category: 'analysis',
  },
  {
    patterns: ['write integration test', 'end to end test',
      'test the full flow', 'acceptance test'],
    route: 'local', level: 4, confidence: 0.70, cost_of_wrong: 'medium',
    category: 'tests',
  },
  ...
  {
    patterns: ['trace this bug', 'root cause', 'investigate',
